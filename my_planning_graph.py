...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        return any(~effectA in actionB.effects for effectA in actionA.effects)\
               or any(~effectB in actionA.effects for effectB in actionB.effects)
    ...
    def _interference(self, actionA, actionB):
        ...
        layers.ActionNode
        """
        return any(~effectB in actionA.preconditions for effectB in actionB.effects)\
               or any(~effectA in actionB.preconditions for effectA in actionA.effects)
    ...
    def _competing_needs(self, actionA, actionB):
        ...
        """
        return any(self.parent_layer.is_mutex(preA, preB) for preA in actionA.preconditions for preB in actionB.preconditions)
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        return all(self.parent_layer.is_mutex(actionA, actionB)
                   for actionA in self.parents[literalA] for actionB in self.parents[literalB])
